...
def run_training(cfg: MetaFMTrainConfig) -> None:
    ...
    trainer.train_curriculum(
        ...
        phase_a_config=cfg.phase_a,
        phase_b_config=cfg.phase_b,
        phase_c_config=cfg.phase_c,
        ...
        checkpoint_every_epochs=cfg.checkpoint.save_every_epochs,
        checkpoint_dir=cfg.checkpoint.resolved_dir(cfg.output.model_dir),
        checkpoint_latest_filename=cfg.checkpoint.latest_filename,
        checkpoint_save_latest=cfg.checkpoint.save_latest,
        pretrained_vae_path=cfg.model.vae_weights,
