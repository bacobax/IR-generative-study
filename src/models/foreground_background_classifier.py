...
class MultiClassForegroundBackgroundClassifier(nn.Module):
    """Compact 1-channel CNN for multiclass object-vs-background classification."""
    ...
    def __init__(
        ...
        *,
        ...
        self.pool = nn.AdaptiveAvgPool2d(1)
        self.dropout = nn.Dropout(float(dropout))
        self.head = nn.Linear(current_channels, int(num_classes))
