...
WEIGHTS_DIR="${WEIGHTS_DIR:-artifacts/checkpoints/stable_diffusion/uncond_runs/diff_scratch_flir_uncond_full/UNET}"
PRESET_PATH="${PRESET_PATH:-configs/datasets/flir/diffusion/diff_scratch_flir_uncond_full.yaml}"
