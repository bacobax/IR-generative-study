#!/usr/bin/env bash
# Guided FM generation: Euler + surprise energy, MAXIMISE (more novel/surprising)
# Guidance pushes toward higher predicted surprise score.
set -euo pipefail
...
python "$ROOT_DIR/generate_datasets.py" \
    ...
    --max_samples 200 \
    --output_dir "$ROOT_DIR/generated/fm_guided_surprise_max" \
    --fm_steps 100 \
    --fm_batch_size 4 \
