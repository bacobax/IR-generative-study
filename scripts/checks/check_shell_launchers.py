...
MIGRATED = {
    ...
    "scripts/generate/sdxl_r8.sh": "configs/sdxl/generate/presets/r8.yaml",
    ...
    "scripts/train/sd_flir_regiondiff_from_lora_r8.sh": "configs/sd_layout/train/presets/lora_sd15_flir_full_bbox_2_stage.yaml",
    ...
    "scripts/train/sdxl_lora_r8.sh": "configs/sdxl/train/presets/lora_r8.yaml",
    ...
    "scripts/train/text_fm.sh": "configs/fm/train/presets/fm_scratch_flir_text_full.yaml",
