...
EXPECTED_FILES = {
    ...
    # Thin wrappers
    "train_flow_matching.py", "adapt_stable_diffusion.py", "train_latent_diffusion.py", "train_vae.py",
    "train_controlnet.py", "generate_datasets.py", "train_sdxl.py", "train_flux.py",
    # Compatibility wrappers for canonical scripts/standalone tools
    "train_count_adapter.py", "analyze_distribution_shift.py",
}
...
for f in ("train_flow_matching.py", "adapt_stable_diffusion.py", "train_latent_diffusion.py", "train_vae.py", "train_controlnet.py", "generate_datasets.py", "train_sdxl.py", "train_flux.py"):
