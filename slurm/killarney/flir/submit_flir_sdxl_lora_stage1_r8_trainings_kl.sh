...
FULL_WORKER="${PROJECT_ROOT}/slurm/killarney/flir/sd_adaptation/train_flir_sdxl_lora_stage1_r8_full_kl.slurm"
TWO_K_WORKER="${PROJECT_ROOT}/slurm/killarney/flir/sd_adaptation/train_flir_sdxl_lora_stage1_r8_train_2000_kl.slurm"
FIVE_K_WORKER="${PROJECT_ROOT}/slurm/killarney/flir/sd_adaptation/train_flir_sdxl_lora_stage1_r8_train_5000_kl.slurm"
